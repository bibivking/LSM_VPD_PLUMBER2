...
def plot_var_VPD_line_box(bin_by=None, window_size=11, order=3,
    ...
    ax[0,0].set_title("Dry (EF<0.2)", fontsize=20)
    ax[0,1].set_title("Wet (EF>0.8)", fontsize=20)
    ...
    ax[0,0].set_xlim(-0.2,10.9)

    ax[0,1].set_xticks([0,1,2,3,4,5])
    ax[0,1].set_xticklabels(['0','1','2', '3','4','5'],fontsize=12)
    ax[0,1].set_xlim(-0.2,9.5)

    ax[1,0].set_xticks([0,1,2,3,4,5,6,7])
    ax[1,0].set_xticklabels(['0','1','2', '3','4','5', '6','7'],fontsize=12)
    ax[1,0].set_xlim(-0.2,10.9)

    ax[1,1].set_xticks([0,1,2,3,4,5])
    ax[1,1].set_xticklabels(['0','1','2', '3','4','5'],fontsize=12)
    ax[1,1].set_xlim(-0.2,9.5)
...
if __name__ == "__main__":
    ...
    plot_var_VPD_line_box_three_col( bin_by=bin_by, window_size=window_size, order=order,
                 smooth_type=smooth_type, method='bin_by_vpd', message=message, model_names=model_names,
                 turning_point=turning_point)
