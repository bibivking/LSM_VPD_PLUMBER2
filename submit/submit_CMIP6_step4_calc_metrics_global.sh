...
cat > calc_predicted_CMIP6_metrics_${scenario}_${model_in}.py << EOF_predicted_CMIP6
#!/usr/bin/env python
...
cat > submit_calc_predicted_CMIP6_metrics_${scenario}_${model_in}.sh << EOF_submit
#!/bin/bash
...
cd /g/data/w97/mm3972/scripts/PLUMBER2/LSM_VPD_PLUMBER2
python calc_predicted_CMIP6_metrics_${scenario}_${model_in}.py

EOF_submit

qsub submit_calc_predicted_CMIP6_metrics_${scenario}_${model_in}.sh
