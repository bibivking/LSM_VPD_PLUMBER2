...
cat > save_predicted_CMIP6_3hourly_${scenario}_${CMIP6_model}_west_EU.py << EOF_predicted_CMIP6
#!/usr/bin/env python
...
cat > submit_predicted_CMIP6_${scenario}_${CMIP6_model}_west_EU.sh << EOF_submit
#!/bin/bash
...
cd /g/data/w97/mm3972/scripts/PLUMBER2/LSM_VPD_PLUMBER2
python save_predicted_CMIP6_3hourly_${scenario}_${CMIP6_model}_west_EU.py

EOF_submit

qsub submit_predicted_CMIP6_${scenario}_${CMIP6_model}_west_EU.sh
